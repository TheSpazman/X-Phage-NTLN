...
tbox_width = 514;									// Width should fit snugly between portraits on game-HUD
tbox_height = 64;									// Height is same as game-portraits, 64px.
tbox_border = 4;									// Border between edge of box and text.
...
global.tbox_text_speed = 1;							// Global Text-Typing Speed
